...
<div id="main" role="main">
    <div id="ribbon">
        ...
        <ol class="breadcrumb">
            <li>Título  <?=$Titulo->NMTitulo?></li>
            <?php json_encode($Titulo)?>
                ...
                <article class="col-lg-11">
                    <div class="jarviswidget jarviswidget-color-darken">
                        <header>
                            ...
                            <h2><?php json_encode($Titulo)?></h2>

                        </header>
                        <div>
                            <div class="widget-body">
                            <form action="<?=base_url()?>TituloMantenedor/PA_UAreaAsignatura" method="post">
                            <div class="row">
									...
									<div class="col-md-3">
										<span>Area</span>
                  						<select class="select2" name="CDTPArea" style="width: 100%"  required>
											<option value="">Seleccione</option>	
											<?php foreach ($Areas as $key => $area) :?>
                                            <?php if(($Titulo->CDTPArea==$area->CDTPArea)):?>
                                                <option <?=($Titulo->CDTPArea==$area->CDTPArea)?"selected":null?> value="<?=$area->CDTPArea;?>"><?=$area->GLTPArea;?></option>	
                                            <?php endif;?>
									...
									<div class="col-md-3">
										<span>Asignatura</span>
                  						<select required name="IDAsignatura" class="select2" style="width: 100%" id="" >
											<option value="">Seleccione</option>	                                           
                                            <?php foreach ($Asignaturas as $key => $asignatura) :?>
                                            <?php if($asignatura->IDAsignatura!=0):?>
                                                <option value="<?=$asignatura->IDAsignatura;?>"><?=$asignatura->GLAsignatura;?></option>	
                                            <?php endif;?>
											<?php endforeach;?>
                  						</select>	
									...
									<div class="col-md-4" >
                                    <input type="hidden" name="IDTitulo" value="<?=$Titulo->IDTitulo?>">
                                    <input type="hidden" name="NMTitulo" value="<?=$Titulo->NMTitulo?>">
		      							<button class="btn btn-primary btn-block" style="margin-top: 15px;">Agregar Asignatura</button>
		      						</div>
