...
<div id="main" role="main">
    <div id="ribbon">
        ...
        <ol class="breadcrumb">
            <li> Manetendor Título / Asignaturas</li>
                                        ...
                                        <table id="tablaTituloExamen" class="table table-striped table-bordered"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <div class="btn-group">
                                                    <a class="btn btn-success btn-xs" href="<?=base_url()?>TituloMantenedor/detalleTitulo/<?=$titulo->IDTitulo?>">
                                                    Editar <i
