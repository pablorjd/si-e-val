                        ...
                        <div>
                            <div class="widget-body" id="calendarioExamen">
                                ...
                                <div class="row visibleCalendarioExamen">
                                    ...
                                    <?php json_encode($buscarCalendarioExamenesReparticion);?>
                                    <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8 col-md-offset-2">
                                        ...
                                        <table id="tablaTituloExamen" class="table table-striped table-bordered"
                                            ...
                                            <tbody>
                                                <?php 'id titulo  '.$IDTitulo.'  id asignatura  '.$IDAsignatura?>
                                                <?php foreach($buscarCalendarioExamenesReparticion as $key => $item ) { ?>
                                                <tr>
                                                    <td><?=($key+1)?></td>
                                                    ...
                                                    <td>
                                                        <form
                                                            action="<?=base_url();?>Evaluaciones/evaluaciones"
                                                            method="POST">
                                                            <!-- onclick="crearExamen();" -->
                                                            <input name="IDTitulo" type="text" hidden="true"
                                                                value="<?=$IDTitulo?>">
                                                            <input name="IDAsignatura" type="text" hidden="true"
                                                                value="<?=$IDAsignatura?>">
                                                                <input name="IDDetalleCalendario" type="text" hidden="true"
                                                                value="<?=$item['IDDetalleCalendario']?>">
                                                                <?php if($item['IDFormatoCalendario'] !=0):?>
                                                                    INGRESADO
                                                                <?php else:?>
                                                                    <button type="submit"
                                                                class="btn btn-default btn-block">Siguiente</button>
                                                                <?php endif;?>
