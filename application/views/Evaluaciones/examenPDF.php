...
<body>
    ...
    <div style="border: salmon">
        ...
        <p align="center" style="text-align: center !important;">
            <center> EJECUCIÓN DE LA EVALUACIÓN DE COMPETENCIA E X A M E N </center><br>
            <center>
                <h3> <?=$NMTitulo?></h3>
            </center>
            <hr>
    ...
    <div>
        ...
        <ol style="text-align:justify">
            <li>Este examen consta de <?=count($listaExamen)?> preguntas y Ud. dispone de
                <?=$listaExamen[0]->NRDuracionminuto?> minutos para responderlo.</li>
                ...
                <table id="tablaTituloExamen">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <p style="background-color:#D1C3C1;"> <?=($key+1).' )'?> Pregunta de la Asignatura
                                    <?=$item->Asignaturas[0]->GLAsignatura?></p>
                                <p><?=$Cadena?></p>
